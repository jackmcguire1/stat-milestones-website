  ...
  <v-app>
    <v-content>
      ...
      <v-navigation-drawer v-model="drawer" location="left" permanent>
        ...
        <v-list-item
          prepend-avatar="data:image/png;base64,"
          title="Extension Analytics"
          @click="openExtAnalytics"
        >
        </v-list-item>
      ...
      <v-main>
        ...
        <v-footer dark justify="center">
          ...
          <v-container justify="center">
            Contact: <strong>support@stat-milestones.dev</strong>
          </v-container>
        </v-footer>
      </v-main>
    </v-content>
